...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<Schema.Destiny.Responses.DestinyLinkedProfilesResponse> Destiny2_GetLinkedProfiles(long membershipId, Schema.BungieMembershipType membershipType, bool? getAllMemberships = null, string authToken = null)
        {
