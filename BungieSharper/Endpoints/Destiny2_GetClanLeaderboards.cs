...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<Dictionary<string, Dictionary<string, Schema.Destiny.HistoricalStats.DestinyLeaderboard>>> Destiny2_GetClanLeaderboards(long groupId, int? maxtop = null, string modes = null, string statid = null, string authToken = null)
        {
