...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<Schema.Destiny.Advanced.AwaInitializeResponse> Destiny2_AwaInitializeRequest(Schema.Destiny.Advanced.AwaPermissionRequested requestBody, string authToken = null)
        {
