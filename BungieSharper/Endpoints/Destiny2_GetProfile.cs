...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
<<<<<<< HEAD
        public async Task<Schema.Destiny.Responses.DestinyProfileResponse> Destiny2_GetProfile(long destinyMembershipId, Schema.BungieMembershipType membershipType, IEnumerable<Schema.Destiny.DestinyComponentType> components = null, string authToken = null, CancellationToken cancelToken = default)
        {
