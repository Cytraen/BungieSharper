...
namespace BungieSharper.Schema.Destiny.Definitions.Progression
{
    ...
    /// </summary>
    public class DestinyProgressionLevelRequirementDefinition : BungieSharper.Schema.Destiny.Definitions.DestinyDefinition
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Schema.Interpolation.InterpolationPointFloat> requirementCurve { get; set; }
        /// <summary>
