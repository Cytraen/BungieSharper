...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<int> Destiny2_ReportOffensivePostGameCarnageReportPlayer(long activityId, Schema.Destiny.Reporting.Requests.DestinyReportOffensePgcrRequest requestBody, string authToken = null)
        {
