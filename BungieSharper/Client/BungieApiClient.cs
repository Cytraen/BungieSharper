...
public class BungieApiClient : IDisposable
{
    ...
    private BungieApiClient()
    {
        ...
        OAuth = new OAuthRequests(_apiAccessor);
    }
    ...
    /// </summary>
    /// <param name="config">
    ///     The <see cref="BungieClientConfig">BungieClientConfig</see> containing the settings for the
    ///     client.
    /// </param>
    ...
    /// </summary>
    public OAuthRequests OAuth { get; }
    ...
    ///     The maximum number of requests to make per second. The absolute maximum is 50, but the
    ///     official limit is 250/10sec/IP (25/sec) If you go higher than 25, you're on your own.
    /// </param>
    ...
    /// <summary>
    ///     Sets the list of <see cref="PlatformErrorCodes">PlatformErrorCodes</see> that will automatically be retried on
    ///     (after waiting for the throttle, if provided)
    /// </summary>
    /// <param name="errorCodes">
    ///     The list of <see cref="PlatformErrorCodes">PlatformErrorCodes</see> to automatically retry
    ///     upon receipt.
    /// </param>
    ...
    /// <param name="errorCodes">
    ///     The list of <see cref="PlatformErrorCodes">PlatformErrorCodes</see> to automatically retry
    ///     upon receipt. Will be converted to a
    ///     <see cref="HashSet{PlatformErrorCodes}">HashSet&lt;PlatformErrorCodes&gt;</see>
    /// </param>
