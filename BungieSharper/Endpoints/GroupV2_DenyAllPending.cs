...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<IEnumerable<Schema.Entities.EntityActionResult>> GroupV2_DenyAllPending(long groupId, Schema.GroupsV2.GroupApplicationRequest requestBody, string authToken = null)
        {
