...
namespace BungieSharper.Schema.Destiny.Definitions.Seasons
{
    ...
    /// </summary>
    public class DestinySeasonDefinition : Destiny.Definitions.DestinyDefinition
    {
    ...
    public class DestinySeasonPassDefinition : Destiny.Definitions.DestinyDefinition
    {
        public Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition displayProperties { get; set; }
