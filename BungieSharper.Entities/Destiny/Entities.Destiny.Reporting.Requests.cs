...
namespace BungieSharper.Entities.Destiny.Reporting.Requests
{
    /// <summary>
    ...
    public class DestinyReportOffensePgcrRequest
    {
        ...
        public IEnumerable<uint> ReasonCategoryHashes { get; set; }
        ...
        public IEnumerable<uint> ReasonHashes { get; set; }
