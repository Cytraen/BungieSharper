...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<Schema.Destiny.Responses.DestinyItemChangeResponse> Destiny2_InsertSocketPlug(Schema.Destiny.Requests.Actions.DestinyInsertPlugsActionRequest requestBody, string authToken = null)
        {
