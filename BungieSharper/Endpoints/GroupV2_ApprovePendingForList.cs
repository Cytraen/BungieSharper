...
namespace BungieSharper.Endpoints
{
    public partial class Endpoints
    {
        ...
        /// </summary>
        public async Task<IEnumerable<Schema.Entities.EntityActionResult>> GroupV2_ApprovePendingForList(long groupId, Schema.GroupsV2.GroupApplicationListRequest requestBody, string authToken = null)
        {
