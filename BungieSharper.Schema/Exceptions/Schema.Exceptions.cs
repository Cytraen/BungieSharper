namespace BungieSharper.Schema.Exceptions
{
    public enum PlatformErrorCodes
    {
        ...
        /// <summary>Deprecated, please do not check for this value anywhere.</summary>
        UnknownSqlResult = 14,
        ...
        /// <summary>Note: This is one of those holdovers from Destiny 1. We didn't change the enum because I am lazy, but in Destiny 2 this would read "DestinyCharacterNotInSocialSpace"</summary>
