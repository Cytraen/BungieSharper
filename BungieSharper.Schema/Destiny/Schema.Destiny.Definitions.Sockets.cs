...
namespace BungieSharper.Schema.Destiny.Definitions.Sockets
{
    ...
    /// </summary>
    public class DestinySocketTypeDefinition : Destiny.Definitions.DestinyDefinition
    {
    ...
    /// </summary>
    public class DestinySocketCategoryDefinition : Destiny.Definitions.DestinyDefinition
    {
        public Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition displayProperties { get; set; }
    ...
    /// </summary>
    public class DestinyPlugSetDefinition : Destiny.Definitions.DestinyDefinition
    {
